...
namespace stellar {
  ...
  public:
    ...
    virtual Peer::pointer getConnectedPeer(my::PeerName const &name) = 0;
    ...
    virtual std::shared_ptr<messageBroker> getMB() = 0;
    ...
    virtual void connectTo(my::PeerName const &name) = 0;
