                             ...
                             PeerStatList const& peerList) const
{
    for (auto const& peer : peerList)
    {
        ...
        peerInfo["messagesRead"] = peer.messagesRead;
        peerInfo["messagesWritten"] = peer.messagesWritten;
        peerInfo["bytesRead"] = peer.bytesRead;
        peerInfo["bytesWritten"] = peer.bytesWritten;
        peerInfo["secondsConnected"] = peer.secondsConnected;

        peerInfo["uniqueFloodBytesRecv"] = peer.uniqueFloodBytesRecv;
        peerInfo["duplicateFloodBytesRecv"] = peer.duplicateFloodBytesRecv;
        peerInfo["uniqueFetchBytesRecv"] = peer.uniqueFetchBytesRecv;
        peerInfo["duplicateFetchBytesRecv"] = peer.duplicateFetchBytesRecv;

        peerInfo["uniqueFloodMessageRecv"] = peer.uniqueFloodMessageRecv;
        peerInfo["duplicateFloodMessageRecv"] = peer.duplicateFloodMessageRecv;
        peerInfo["uniqueFetchMessageRecv"] = peer.uniqueFetchMessageRecv;
        peerInfo["duplicateFetchMessageRecv"] = peer.duplicateFetchMessageRecv;
